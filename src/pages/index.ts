...
export { default as PaymentSuccess } from './customer/payment/payment-success'
export { default as PaymentFail } from './customer/payment/payment-failed'
...
export { default as CheckAiArtWorks} from './staff/check-ai-artworks'
export { default as ManageReports} from './staff/manage-reports'
